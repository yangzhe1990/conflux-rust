...
impl Directories {
    ...
    pub fn create_dirs(
        &self, dapps_enabled: bool, signer_enabled: bool,
...
/// Get home directory.
fn home() -> PathBuf { env::home_dir().expect("Failed to get home dir") }

/// Conflux path for specific ledger
pub fn conflux(ledger: &str) -> PathBuf {
    let mut base = conflux_base();
    base.push(ledger);
    base
}
...
mod platform {
    ...
    pub const AUTHOR: &'static str = "Conflux";
    pub const PRODUCT: &'static str = "Conflux";
    pub const PRODUCT_HYPERVISOR: &'static str = "Conflux";

    pub fn conflux_base() -> PathBuf {
