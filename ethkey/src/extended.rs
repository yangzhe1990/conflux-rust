...
impl Label for H256 {
    ...
    fn store(&self, target: &mut [u8]) { self.copy_to(&mut target[0..32]); }
}
...
impl ExtendedKeyPair {
    ...
    pub fn with_seed(seed: &[u8]) -> Result<ExtendedKeyPair, DerivationError> {
        ...
        Ok(ExtendedKeyPair::with_secret(
            Secret::from_unsafe_slice(&*master_key)
...
mod tests {
    ...
    fn smoky() {
        ...
        assert_eq!(
            ...
            &"0927453daed47839608e414a3738dfad10aed17c459bbd9ab53f89b026c834b6"
                .into()
        );
        assert_eq!(
            &**extended_secret.derive(2147483649.into()).as_raw(),
            &"44238b6a29c6dcbe9b401364141ba11e2198c289a5fed243a1c11af35c19dc0f"
                .into()
        );
        ...
        assert_eq!(
            ...
            &"bf6a74e3f7b36fc4c96a1e12f31abc817f9f5904f5a8fc27713163d1f0b713f6"
                .into()
        );
        assert_eq!(
            &**extended_secret.derive(1.into()).as_raw(),
            &"bd4fca9eb1f9c201e9448c1eecd66e302d68d4d313ce895b8c134f512205c1bc"
                .into()
        );
        assert_eq!(
            &**extended_secret.derive(2.into()).as_raw(),
            &"86932b542d6cab4d9c65490c7ef502d89ecc0e2a5f4852157649e3251e2a3268"
                .into()
        );
        ...
        assert_eq!(
            &**keypair
                ...
                .secret()
                .as_raw(),
            &"edef54414c03196557cf73774bc97a645c9a1df2164ed34f0c2a78d1375a930c"
                .into()
        );
    }
    ...
    fn h256_hard() {
        ...
        assert_eq!(
            &**extended_secret
                ...
                .as_raw(),
            &"2bc2d696fb744d77ff813b4a1ef0ad64e1e5188b622c54ba917acc5ebc7c5486"
                .into()
        );
    }
