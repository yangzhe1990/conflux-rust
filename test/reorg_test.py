...
class P2PTest(ConfluxTestFramework):
    ...
    def run_test(self):
        ...
        block_gen_thread = BlockGenThread(self.nodes, self.log, random.random(), 0.2)
...
class BlockGenThread(threading.Thread):
    def __init__(self, nodes, log, seed, interval):
