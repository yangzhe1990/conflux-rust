...
class P2PTest(ConfluxTestFramework):
    ...
    def run_test(self):
        ...
        block1 = create_block(parent_hash=decode_hex(best_block), timestamp=1, difficulty=1)
        block2 = create_block(parent_hash=decode_hex(best_block), timestamp=2, difficulty=1)
